...
const messages = {
  ko: {
    ...
    viewAll: '전체 보기 →',
    whyLearnNexus: '왜 LearnNexus인가요?',
    startNow: '지금 바로 시작하세요',
    ctaDescription: '수백 명의 유학생들이 LearnNexus와 함께 성장하고 있습니다.',
    startFree: '무료로 시작하기',
    ...
    backHome: '← 홈으로',
    loginDescription: 'LearnNexus 계정으로 로그인합니다.',
    noAccount: '계정이 없으신가요?',
    register: '회원가입',
    name: '이름',
    email: '이메일',
  ...
  en: {
    ...
    landingBadge: 'MSA-based service platform', landingTitleLine1: 'Make life easier,', landingTitleLine2: 'and learning faster', browseServices: 'Browse Services', studentsAbroad: 'International Students', users: 'Student Users', popularServices: 'Popular Services', viewAll: 'View All →', whyLearnNexus: 'Why LearnNexus?', startNow: 'Get started today', ctaDescription: 'Hundreds of international students are growing with LearnNexus.', startFree: 'Start for Free',
  ...
  zh: {
    ...
    landingBadge: '基于 MSA 的服务平台', landingTitleLine1: '让生活更便利，', landingTitleLine2: '让学习更高效', browseServices: '浏览服务', studentsAbroad: '留学生', users: '使用学生', popularServices: '热门服务', viewAll: '查看全部 →', whyLearnNexus: '为什么选择 LearnNexus？', startNow: '立即开始', ctaDescription: '数百名留学生正在与 LearnNexus 一起成长。', startFree: '免费开始',
    ...
    department: '负责部门', applicants: '申请人数', peopleUnit: '{count}人', processing: '处理中...', availableImmediately: '✅ 可立即申请', applicationHistory: '✅ 可随时查看申请记录', departmentGuide: '✅ 提供负责部门指南', serviceLoadFailed: '无法加载服务信息。', defaultServiceDescription: '这是由学校管理员准备的项目，您可以获得所需支持。', departmentUnknown: '暂无负责部门信息', operatorCannotApply: '管理员不可申请', goToApplications: '前往我的申请', applicationPending: '申请完成 · 处理中', apply: '申请', operatorHelp: '管理员无法申请自己注册的项目。', activeHelp: '您已申请此服务，可在我的申请中查看。', pendingHelp: '申请已提交，可在我的申请中查看处理状态。', applyHelp: '提交后即完成申请，如为付费服务则同时完成付款。',
  ...
  ja: {
    ...
    landingBadge: 'MSAベースのサービス提供プラットフォーム', landingTitleLine1: '生活をもっと便利に、', landingTitleLine2: '学びをもっと速く', browseServices: 'サービスを見る', studentsAbroad: '留学生', users: '利用学生', popularServices: '人気サービス', viewAll: 'すべて見る →', whyLearnNexus: 'LearnNexusを選ぶ理由', startNow: '今すぐ始めましょう', ctaDescription: '多くの留学生がLearnNexusとともに成長しています。', startFree: '無料で始める',
    ...
    department: '担当部署', applicants: '申請者', peopleUnit: '{count}名', processing: '処理中...', availableImmediately: '✅ すぐに申請可能', applicationHistory: '✅ 申請履歴をいつでも確認', departmentGuide: '✅ 担当部署の案内を提供', serviceLoadFailed: 'サービス情報を読み込めませんでした。', defaultServiceDescription: '学校管理者が用意したプログラムで、必要な支援を受けられます。', departmentUnknown: '担当部署の情報がありません', operatorCannotApply: '管理者は申請できません', goToApplications: '申請一覧へ移動', applicationPending: '申請完了・処理中', apply: '申請する', operatorHelp: '管理者は自分が登録したプログラムに申請できません。', activeHelp: 'すでに申請済みです。申請一覧から確認できます。', pendingHelp: '申請を受け付けました。処理状況は申請一覧で確認できます。', applyHelp: '申請すると、有料サービスの場合は決済と同時に受付が完了します。',
  ...
  vi: {
    ...
    landingBadge: 'Nền tảng cung cấp dịch vụ dựa trên MSA', landingTitleLine1: 'Cuộc sống tiện lợi hơn,', landingTitleLine2: 'học tập nhanh hơn', browseServices: 'Khám phá dịch vụ', studentsAbroad: 'Du học sinh', users: 'Sinh viên sử dụng', popularServices: 'Dịch vụ phổ biến', viewAll: 'Xem tất cả →', whyLearnNexus: 'Tại sao chọn LearnNexus?', startNow: 'Bắt đầu ngay hôm nay', ctaDescription: 'Hàng trăm du học sinh đang phát triển cùng LearnNexus.', startFree: 'Bắt đầu miễn phí',
    ...
    department: 'Bộ phận phụ trách', applicants: 'Người đăng ký', peopleUnit: '{count} người', processing: 'Đang xử lý...', availableImmediately: '✅ Có thể đăng ký ngay', applicationHistory: '✅ Xem trạng thái đăng ký bất cứ lúc nào', departmentGuide: '✅ Có hướng dẫn từ bộ phận phụ trách', serviceLoadFailed: 'Không thể tải thông tin dịch vụ.', defaultServiceDescription: 'Nhận hỗ trợ cần thiết qua chương trình do nhà trường chuẩn bị.', departmentUnknown: 'Chưa có thông tin bộ phận phụ trách', operatorCannotApply: 'Quản trị viên không thể đăng ký', goToApplications: 'Đi đến đơn đăng ký của tôi', applicationPending: 'Đã đăng ký · Đang xử lý', apply: 'Đăng ký', operatorHelp: 'Quản trị viên không thể đăng ký chương trình do mình tạo.', activeHelp: 'Bạn đã đăng ký dịch vụ này. Hãy kiểm tra trong danh sách đơn đăng ký.', pendingHelp: 'Đơn đã được tiếp nhận. Bạn có thể kiểm tra trạng thái trong danh sách đơn đăng ký.', applyHelp: 'Khi gửi đơn, việc đăng ký và thanh toán (nếu có) sẽ được hoàn tất.',
...
export function useI18n() {
  ...
  return { locale, setLocale, t, translateCourseTitle }
}
