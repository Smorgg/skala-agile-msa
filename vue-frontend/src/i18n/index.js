...
const messages = {
  ...
  en: {
    ...
    landingBadge: 'MSA-based service platform', landingTitleLine1: 'Make life easier,', landingTitleLine2: 'and learning faster', browseServices: 'Browse Services', studentsAbroad: 'International Students', users: 'Users', popularServices: 'Popular Services', viewAll: 'View All →', whyLearnNexus: 'Why K-mate?', startNow: 'Get started today', ctaDescription: 'Hundreds of international students are growing with K-mate.', startFree: 'Start for Free',
    ...
    healthcare: 'Healthcare', backend: 'Backend', frontend: 'Frontend', data: 'Data', finance: 'Finance', admin: 'Administration', security: 'Legal & Safety', academic: 'Academic', life: 'Life', all: 'All', enrolledCount: '{count} users',
  ...
  zh: {
    ...
    landingBadge: '基于 MSA 的服务平台', landingTitleLine1: '让生活更便利，', landingTitleLine2: '让学习更高效', browseServices: '浏览服务', studentsAbroad: '留学生', users: '用户', popularServices: '热门服务', viewAll: '查看全部 →', whyLearnNexus: '为什么选择 K-mate？', startNow: '立即开始', ctaDescription: '数百名留学生正在与 K-mate 一起成长。', startFree: '免费开始',
    ...
    healthcare: '医疗', backend: '后端', frontend: '前端', data: '数据', finance: '金融', admin: '行政', security: '法律与安全', academic: '学业', life: '生活', all: '全部', enrolledCount: '{count}名用户',
  ...
  ja: {
    ...
    landingBadge: 'MSAベースのサービス提供プラットフォーム', landingTitleLine1: '生活をもっと便利に、', landingTitleLine2: '学びをもっと速く', browseServices: 'サービスを見る', studentsAbroad: '留学生', users: '利用者', popularServices: '人気サービス', viewAll: 'すべて見る →', whyLearnNexus: 'K-mateを選ぶ理由', startNow: '今すぐ始めましょう', ctaDescription: '多くの留学生がk-mateとともに成長しています。', startFree: '無料で始める',
    ...
    healthcare: '医療', backend: 'バックエンド', frontend: 'フロントエンド', data: 'データ', finance: '金融', admin: '行政', security: '法律・安全', academic: '学業', life: '生活', all: 'すべて', enrolledCount: '利用者 {count}名',
  ...
  vi: {
    ...
    landingBadge: 'Nền tảng cung cấp dịch vụ dựa trên MSA', landingTitleLine1: 'Cuộc sống tiện lợi hơn,', landingTitleLine2: 'học tập nhanh hơn', browseServices: 'Khám phá dịch vụ', studentsAbroad: 'Du học sinh', users: 'Người dùng', popularServices: 'Dịch vụ phổ biến', viewAll: 'Xem tất cả →', whyLearnNexus: 'Tại sao chọn K-mate?', startNow: 'Bắt đầu ngay hôm nay', ctaDescription: 'Hàng trăm du học sinh đang phát triển cùng K-mate.', startFree: 'Bắt đầu miễn phí',
    ...
    healthcare: 'Y tế', backend: 'Backend', frontend: 'Frontend', data: 'Dữ liệu', finance: 'Tài chính', admin: 'Hành chính', security: 'Pháp lý & An toàn', academic: 'Học tập', life: 'Đời sống', all: 'Tất cả', enrolledCount: '{count} người dùng',
